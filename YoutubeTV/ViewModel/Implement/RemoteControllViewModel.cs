...
namespace YoutubeTV.ViewModel.Implement
{
    ...
    /// </summary>
    public class RemoteControllViewModel : ViewModelBase, IRemoteControllViewModel

    {
        ...
        public Action<ChannelModel> OnChannelChanged;

        public RemoteControllViewModel()
        {
        }

        public RemoteControllViewModel(IChannelProvider channelProvider)
        {
